      ...
      <div className="space-y-8">
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">Config API</h1>
              <p className="text-gray-400">Gerencie APIs e conexões externas da plataforma</p>
            </div>
          </div>
        </motion.div>
              ...
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription className="text-gray-400">
                      Status da conexão e estatísticas do banco de dados
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
